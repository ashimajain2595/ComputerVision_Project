...
newpath = '/media/aj/OS/Users/SURENDRA JAIN/Documents/AJ/Acads/VIII sem/EE 625/ComputerVision_Project/Training images/Manual classification 02/svm_data_oxidation/'
for fname in filelist:
    oldname = oldpath + fname + 'c0.bmp'
    newname = newpath + fname + 'c0.bmp'
